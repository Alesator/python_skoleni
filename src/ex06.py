...
class Animal:
    ...
    def gift(self, donor_id: str, amount: int):
        ...
        if key in self.donors:
            self.donors[key] = int(self.donors[key]) + amount
        else:
            self.donors[key] = amount
...
print( a1 )
#-> name: Lion Simba; birth: 1994; origin: Africa; donors: 7009383869 (8000), 9503833333(4000)
...
print( f1 )
#-> name: Clownfish Nemo; birth: 2003; origin: Pacific; water: saltwater; donors: 7009383869 (80), 9503833333 (40)
